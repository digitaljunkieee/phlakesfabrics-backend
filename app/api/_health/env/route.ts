...
export async function GET() {
  ...
  const cloudinarySigned = !!process.env.CLOUDINARY_CLOUD_NAME && !!process.env.CLOUDINARY_API_KEY && !!process.env.CLOUDINARY_API_SECRET && process.env.CLOUDINARY_API_KEY !== process.env.CLOUDINARY_API_SECRET

  return NextResponse.json({
    mongoDb: !!process.env.MONGODB_URI,
    paystack: !!process.env.PAYSTACK_SECRET_KEY,
    cloudinary: cloudinaryUrl || cloudinaryUploadPreset || cloudinarySigned,
    cloudinaryUrl,
