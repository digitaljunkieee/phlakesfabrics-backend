...
function normalizeImportRecord(input: unknown) {
  ...
  const normalized: JsonRecord = {
    ...
    homepage_sections: record.homepage_sections ?? record.homepageSections ?? record.homepage_section,
  ...
  return NextResponse.json({
    ...
    data: {
      ...
      example: {
        ...
        homepage_sections: 'new-arrivals|campaign-shelf',
        images: 'https://example.com/image-1.jpg|https://example.com/image-2.jpg',
        specs: 'fabricType:Brocade;materialComposition:Premium woven brocade',
        status: 'published',
      },
    },
  });
